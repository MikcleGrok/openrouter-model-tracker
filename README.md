...
Ширина первой колонки ограничена 40 display columns и в pager mode не сохраняется сверх этого
предела; `less -S` по-прежнему позволяет горизонтально прокручивать остальные колонки.
