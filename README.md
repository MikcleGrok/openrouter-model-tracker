...
применяется одинаково в CLI и TUI. По умолчанию это 2 пробела; принимаются
значения от 0 до 8. Некорректные, отрицательные и слишком большие значения
возвращаются к 2. Между именем производителя и названием модели всегда остаётся
один пробел.
