...
Короткий тур по TUI: главный экран с ранжированной таблицей → карточка модели
→ переключение фильтра доступности (`p`, paid/free) на бесплатные модели —
без выхода из приложения:

![TUI: главная таблица, карточка модели, переключение на бесплатные модели](docs/assets/tui-demo.gif)
