...
|---|---|---|---|---|---|---|---|
| ≈ Claude Fable 5 | нет достойного кандидата | — | — | — | — | — | Ни одна проверенная модель независимо не подтверждает Fable-уровень. |
| >≈ Claude Opus 5 | GPT-5.6 Luna | $0.50 / $3.00 ($1.00 / $4.00 от 272K+) · 1M | 93.0% | 82.7 | OpenAI (C) | нет | Лучшее соотношение цена/качество. |
...
|---|---|---|---|---|---|---|---|
| NVIDIA Nemotron 3 Ultra | `nvidia/nemotron-3-ultra-550b-a55b:free` | 1M | 65–70.4% (только вендор) | <≈ Claude Haiku 4.5 (бесплатная) | NVIDIA | да, OpenMDW-1.1 | 550B/55B-active MoE. |
