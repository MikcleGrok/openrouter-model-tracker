...
| ≈ Opus 5 | GPT-5.6 Luna | $0.50 / $3.00 · 1M | 93.0% | 82.7 | OpenAI (C) | нет | Лучшее соотношение цена/качество. |
...
|---|---|---|---|---|---|---|---|---|---|
| GPT-5.6 Luna | openai/gpt-5.6-luna | $0.50 | $3.00 | 1M | 93.0% | 82.7 | OpenAI (C) | нет | Независимая оценка (vals.ai). |
