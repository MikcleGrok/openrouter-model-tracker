...
func TestNewSnapshot(t *testing.T) {
	...
	if string(body) != `{"in_per_m":1,"out_per_m":2,"context":100000,"copyright":"unknown","score":{"metric":"","value":50,"variant_measured":"","source_url":"","checked":"","provenance":"","canonical_id":"","release_variant":"","model_variant":"","reasoning":"","configuration":"","provider":"","uncertainty":"","sample_size":"","harness":"","scaffold":""}}` {
