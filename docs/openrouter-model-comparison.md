...
| ≈ Sonnet 5 | GLM-5.2 | $0.22 / $0.69 · 1M | 82.8% | 245 | Z.ai / Zhipu AI (D−) | **да, MIT** | _нужен обзор_ |
...
| Модель | Slug на OpenRouter | Вход $/M | Выход $/M | Контекст | SWE-bench Verified | Качество/цена | Владелец (FLI) | Открытые веса | Примечание |
|---|---|---|---|---|---|---|---|---|---|
| GLM-5.2 | z-ai/glm-5.2 | $0.22 | $0.69 | 1M | 82.8% | 245 | Z.ai / Zhipu AI (D−) | **да, MIT** | Официальная документация Z.AI SWE-bench Verified не публикует — там только SWE-bench Pro 62.1% и Terminal-Bench 2.1 81.0% (другие метрики). Независимая оценка SWE-bench Verified есть на vals.ai (82.8%). Модель по-прежнему сильна в агентных задачах. |
...
| Llama 4 Maverick | meta-llama/llama-4-maverick | $0.20 | $0.80 | 1M | 21.0% | 60.1 | Meta (D+) | **да** (Llama 4 Community License, ограничения при >700M MAU) | Старое поколение (апрель 2025), больше не флагман Meta (теперь — Muse Spark). Независимая оценка SWE-bench Verified теперь есть на swebench.com (21.0%) — заметно ниже циркулировавших ранее непроверенных чисел (~24%, 49.2%, а 8.0% — вообще по SWE-bench **Lite**). |
