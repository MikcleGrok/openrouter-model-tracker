...
Обновлено: 2026-08-09 (цены и контекст получены из каталога OpenRouter (/api/v1/models), оценки — с vals.ai и swebench.com по ручной карте model-map.tsv (21 запись vals=, 6 записей swebench=); остальные числа заданы вручную в notes.yaml и помечены как вендорские)
