...
func tuiDetailTabBar(active int, lang string, widths ...int) string {
	...
	if width > 0 && width < 80 {
		return fmt.Sprintf("[%d/%d] %s", active+1, detailTabCount, activeTitle)
	}
